...
const MISSIONS: Mission[] = [
  ...
  { id: 'm9', title: 'Nebula Sound Pro', slug: '/nebula-sound', pillar: 'PRODUCT-DEMO', outcome: 'Immersive audio-visual product demonstration.', isLive: false, tech: 'Next.js + Tailwind' },
