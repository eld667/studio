    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6 max-w-6xl">
        <div className="mb-16 text-left">
          <FadeIn>
            <span className="font-mono text-[10px] text-blue-400 tracking-[0.3em] uppercase block mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-4">
          ...
          <FadeIn className="lg:col-span-6 h-full" delay={0.1}>
            <div className="group relative h-full bg-white/[0.03] backdrop-blur-md border border-white/[0.08] p-8 md:p-12 rounded-[2rem] transition-colors hover:border-white/20">
              <div className="flex flex-col h-full justify-between gap-12">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  ...
                  >
                    <Button size="lg" className="w-full bg-white text-black hover:bg-zinc-200 font-bold uppercase tracking-widest text-[10px] h-14 px-8 rounded-none">
                      Claim Your Package
                    </Button>
                  </motion.div>
                  <button className="text-[10px] font-mono uppercase tracking-[0.2em] text-white/40 hover:text-white transition-colors flex items-center gap-2">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            <FadeIn className="h-full" delay={0.2}>
              <div className="group relative h-full bg-white/[0.03] backdrop-blur-md border border-white/[0.08] p-8 rounded-[2rem] transition-colors hover:border-white/20">
