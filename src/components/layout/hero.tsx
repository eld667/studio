  ...
  return (
    <section className="relative w-full flex flex-col items-center justify-center h-screen">
      ...
      <div className="container relative z-10 flex h-full flex-col items-center justify-center gap-6 px-4 text-center sm:px-6 lg:px-8">
        <FadeIn>
          <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-purple-400 via-blue-500 to-emerald-400 bg-clip-text text-transparent text-zinc-100 [filter:drop-shadow(0_0_10px_rgba(59,130,246,0.5))]">
        ...
        <FadeIn delay={0.4}>
          <Button
            ...
            className="font-medium text-primary-foreground bg-gradient-to-r from-purple-400 via-blue-500 to-emerald-400 transition-all duration-300 ease-in-out drop-shadow-[0_0_5px_rgba(192,132,252,0.7)] drop-shadow(0 0 10px rgba(59,130,246,0.5)) hover:drop-shadow-[0_0_10px_rgba(192,132,252,1)] hover:drop-shadow-[0_0_15px_rgba(59,130,246,0.8)]"
          >
            Explore Our Work
          </Button>
        </FadeIn>
